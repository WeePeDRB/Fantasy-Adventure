...
public class MonsterSpecialEffectController
{
    ...
    // Initialize data
    public MonsterSpecialEffectController(MonsterController monsterController)
    {
    ...
    public void ReceiveEffect(SpecialEffectBase effect)
    {
        ...
        else
        {
            ...
            {
                effect.ApplyEffectOnMonster(monsterController);
            }
    ...
    public void UpdateEffect(float deltaTime)
    {
        ...
        foreach (SpecialEffectBase effect in effectToRemove)
        {
            ...
            if (effect.SpEffectType == EffectType.Instant)
            {
                ...
                effect.RemoveEffectFromMonster(monsterController);
            }
