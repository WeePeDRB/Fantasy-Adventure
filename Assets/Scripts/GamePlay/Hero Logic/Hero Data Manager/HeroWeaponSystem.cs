...
public class HeroWeaponSystem
{
    ...
    // FIELDS
    //
    private Dictionary<string, WeaponBaseOld> activeWeapons;
    ...
    {
        activeWeapons = new Dictionary<string, WeaponBaseOld>();
    ...
    // Dictionary logic
    public void ReceiveWeapon(SO_Weapon weaponData, WeaponBaseOld weapon)
    {
    ...
    {
        WeaponBaseOld weapon = GetWeapon(weaponData);
    ...
    // Get data
    public WeaponBaseOld GetWeapon(SO_Weapon weaponData)
    {
