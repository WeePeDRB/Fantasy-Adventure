...
public class HeroBlessingSystem : CharacterBlessingSystem
{
    ...
    // Dictionary logic
    public void ReceiveBlessing(SO_Blessing blessingData, BlessingBase blessing, HeroBaseController hero)
    {
    ...
    // Get data
    public BlessingBase GetBlessing(SO_Blessing blessingData)
    {
